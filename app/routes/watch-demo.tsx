        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900">
                <div className="text-center">
                  <div className="w-20 h-20 bg-valencia-500 rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-valencia-600 transition-colors cursor-pointer">
                    <Play className="h-8 w-8 text-white ml-1" />
                  </div>
                  <p className="text-white text-lg">CallKaira Demo Video</p>
          ...
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600 mb-16">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-valencia-500 rounded-full"></div>
              3 minute demo
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-valencia-500 rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {demoFeatures.map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-gray-50 to-valencia-50 rounded-2xl p-8">
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-valencia-500 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="font-semibold text-2xl text-gray-900 mb-6 text-center">
              Real Business Scenarios Demonstrated
            </h3>
            <div className="grid md:grid-cols-2 gap-4">
              {realScenarios.map((scenario, index) => (
                <div key={index} className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-valencia-500 rounded-full flex-shrink-0"></div>
      ...
      <section className="py-20 bg-gradient-to-br from-valencia-500 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Link
              to="/pricing"
              className="inline-flex items-center border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-valencia-500 transition-all duration-300"
            >
              View Pricing
            </Link>
          </div>
